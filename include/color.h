/** \file color.h
 *  \brief Minimal ANSI color enable/disable helpers.
 *
 *  Automatically disables colors when stdout is not a TTY or the environment
 *  variable NO_COLOR is present. FORCE_COLOR overrides and enables colors.
 */
#ifndef COLOR_H
#define COLOR_H
